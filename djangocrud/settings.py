...
SECRET_KEY = 'django-insecure-3_jie%nsj&p9$rq7#&d9)pa5if&&6*w5q7^yw_$_&1%16w@kj+'
...
#       'DIRS': ['C:/Users/crisc/Documents/GitHub/GRUPO-3-PIS/tasks/Templates'],
        'DIRS': [os.path.join(BASE_DIR / 'Repetix/Templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR / 'Repetix/static')]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'repetix.unl@gmail.com'
EMAIL_HOST_PASSWORD = 'repetix.unl123' 
